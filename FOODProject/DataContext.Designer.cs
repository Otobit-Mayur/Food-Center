...
// Code is generated on: 17-03-2022 13:33:38
//
...
namespace FoodCenterContext
{
    ...
    public partial class ShopAddress : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<ShopDetail> _ShopDetail_ShopId;
        ...
        public ShopAddress()
        {
            ...
            this._ShopDetail_ShopId  = default(EntityRef<ShopDetail>);
            OnCreated();
        }
        ...
        /// <summary>
        /// There are no comments for ShopDetail_ShopId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ShopDetail_ShopAddress1", Storage="_ShopDetail_ShopId", ThisKey="ShopId", OtherKey="ShopId", IsForeignKey=true)]
        public ShopDetail ShopDetail_ShopId
        {
            get
            {
                return this._ShopDetail_ShopId.Entity;
            }
            set
            {
                ShopDetail previousValue = this._ShopDetail_ShopId.Entity;
                if ((previousValue != value) || (this._ShopDetail_ShopId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("ShopDetail_ShopId");
                    if (previousValue != null)
                    {
                        this._ShopDetail_ShopId.Entity = null;
                        previousValue.ShopAddresses_ShopId.Remove(this);
                    }
                    this._ShopDetail_ShopId.Entity = value;
                    if (value != null)
                    {
                        this._ShopId = value.ShopId;
                        value.ShopAddresses_ShopId.Add(this);
                    }
                    else
                    {
                        this._ShopId = default(int?);
                    }
                    this.SendPropertyChanged("ShopDetail_ShopId");
                }
            }
        }
    ...
    public partial class OfficeAddress : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Address", DbType = "NVARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class ShopDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<ShopAddress> _Addresses;
        ...
        private EntitySet<ShopAddress> _ShopAddresses_ShopId;
        ...
        public ShopDetail()
        {
            this._Addresses = new EntitySet<ShopAddress>(new Action<ShopAddress>(this.attach_Addresses), new Action<ShopAddress>(this.detach_Addresses));
            ...
            this._User  = default(EntityRef<User>);
            this._Subscribers = new EntitySet<Subscriber>(new Action<Subscriber>(this.attach_Subscribers), new Action<Subscriber>(this.detach_Subscribers));
            this._ShopAddresses_ShopId = new EntitySet<ShopAddress>(new Action<ShopAddress>(this.attach_ShopAddresses_ShopId), new Action<ShopAddress>(this.detach_ShopAddresses_ShopId));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ShopDetail_ShopAddress", Storage="_Addresses", ThisKey="ShopId", OtherKey="ShopId", DeleteRule="NO ACTION")]
        public EntitySet<ShopAddress> Addresses
        {
            get
            {
        ...
        /// <summary>
        /// There are no comments for ShopAddresses_ShopId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="ShopDetail_ShopAddress1", Storage="_ShopAddresses_ShopId", ThisKey="ShopId", OtherKey="ShopId", DeleteRule="NO ACTION")]
        public EntitySet<ShopAddress> ShopAddresses_ShopId
        {
            get
            {
                return this._ShopAddresses_ShopId;
            }
            set
            {
                this._ShopAddresses_ShopId.Assign(value);
            }
        }
        ...
        private void attach_Addresses(ShopAddress entity)
        {
            this.SendPropertyChanging("Addresses");
            entity.ShopDetail = this;
        }
    
        private void detach_Addresses(ShopAddress entity)
        {
            this.SendPropertyChanging("Addresses");
        ...
        private void attach_ShopAddresses_ShopId(ShopAddress entity)
        {
            this.SendPropertyChanging("ShopAddresses_ShopId");
            entity.ShopDetail_ShopId = this;
        }
    
        private void detach_ShopAddresses_ShopId(ShopAddress entity)
        {
            this.SendPropertyChanging("ShopAddresses_ShopId");
            entity.ShopDetail_ShopId = null;
        }
    }
