...
// Code is generated on: 29-03-2022 17:14:03
//
...
namespace FoodCenterContext
{
    ...
    public partial class EmployeeDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_OfficeLocation", DbType = "NVARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class OfficeDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<WalletDetail> _Wallets;

        private EntitySet<WalletDetail> _WalletDetails_OfficeId;
        ...
        public OfficeDetail()
        {
            ...
            this._Wallets = new EntitySet<WalletDetail>(new Action<WalletDetail>(this.attach_Wallets), new Action<WalletDetail>(this.detach_Wallets));
            this._WalletDetails_OfficeId = new EntitySet<WalletDetail>(new Action<WalletDetail>(this.attach_WalletDetails_OfficeId), new Action<WalletDetail>(this.detach_WalletDetails_OfficeId));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="OfficeDetail_WalletDetail", Storage="_Wallets", ThisKey="OfficeId", OtherKey="OfficeId", DeleteRule="NO ACTION")]
        public EntitySet<WalletDetail> Wallets
        {
            get
            {
        ...
        /// <summary>
        /// There are no comments for WalletDetails_OfficeId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="OfficeDetail_WalletDetail1", Storage="_WalletDetails_OfficeId", ThisKey="OfficeId", OtherKey="OfficeId", DeleteRule="NO ACTION")]
        public EntitySet<WalletDetail> WalletDetails_OfficeId
        {
            get
            {
                return this._WalletDetails_OfficeId;
            }
            set
            {
                this._WalletDetails_OfficeId.Assign(value);
            }
        }
        ...
        private void attach_Wallets(WalletDetail entity)
        {
            this.SendPropertyChanging("Wallets");
            entity.OfficeDetail = this;
        }
    
        private void detach_Wallets(WalletDetail entity)
        {
            this.SendPropertyChanging("Wallets");
            entity.OfficeDetail = null;
        }

        private void attach_WalletDetails_OfficeId(WalletDetail entity)
        {
            this.SendPropertyChanging("WalletDetails_OfficeId");
            entity.OfficeDetail_OfficeId = this;
        }
    
        private void detach_WalletDetails_OfficeId(WalletDetail entity)
        {
            this.SendPropertyChanging("WalletDetails_OfficeId");
            entity.OfficeDetail_OfficeId = null;
        }
    }
    ...
    public partial class OrderDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_IsRejected", DbType = "NVARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class Subscriber : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Subscription", DbType = "NVARCHAR(50)", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class WalletDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<OfficeDetail> _OfficeDetail_OfficeId;
        ...
        {
            this._OfficeDetail  = default(EntityRef<OfficeDetail>);
            this._OfficeDetail_OfficeId  = default(EntityRef<OfficeDetail>);
            OnCreated();
        }
        ...
        /// </summary>
        [Column(Storage = "_Balance", DbType = "DECIMAL(7)", UpdateCheck = UpdateCheck.Never)]
        ...
        /// <summary>
        /// There are no comments for OfficeDetail_OfficeId in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="OfficeDetail_WalletDetail1", Storage="_OfficeDetail_OfficeId", ThisKey="OfficeId", OtherKey="OfficeId", IsForeignKey=true)]
        public OfficeDetail OfficeDetail_OfficeId
        {
            get
            {
                return this._OfficeDetail_OfficeId.Entity;
            }
            set
            {
                OfficeDetail previousValue = this._OfficeDetail_OfficeId.Entity;
                if ((previousValue != value) || (this._OfficeDetail_OfficeId.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("OfficeDetail_OfficeId");
                    if (previousValue != null)
                    {
                        this._OfficeDetail_OfficeId.Entity = null;
                        previousValue.WalletDetails_OfficeId.Remove(this);
                    }
                    this._OfficeDetail_OfficeId.Entity = value;
                    if (value != null)
                    {
                        this._OfficeId = value.OfficeId;
                        value.WalletDetails_OfficeId.Add(this);
                    }
                    else
                    {
                        this._OfficeId = default(int?);
                    }
                    this.SendPropertyChanged("OfficeDetail_OfficeId");
                }
            }
        }
