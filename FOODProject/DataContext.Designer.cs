...
// Code is generated on: 5/13/2022 2:37:00 PM
//
...
namespace FoodCenterContext
{
    ...
    public partial class FixLookUp : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="FixLookUp_Product", Storage="_Products", ThisKey="FixId", OtherKey="FoodType", DeleteRule="NO ACTION")]
        ...
        private void attach_Products(Product entity)
        {
            ...
            entity.FixLookUp = this;
        }
    
        private void detach_Products(Product entity)
        {
            this.SendPropertyChanging("Products");
            entity.FixLookUp = null;
        }
    }
    ...
    public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntityRef<FixLookUp> _FixLookUp;
        ...
        partial void OnStatusChanged();
        partial void OnFoodTypeChanging(int? value);
        ...
        public Product()
        {
            ...
            this._FixLookUp  = default(EntityRef<FixLookUp>);
            OnCreated();
        }
        ...
        /// </summary>
        [Column(Storage = "_FoodType", DbType = "INT", UpdateCheck = UpdateCheck.Never)]
        public int? FoodType
        {
            get
            {
            ...
            set
            {
                ...
                {
                    if (this._FixLookUp.HasLoadedOrAssignedValue)
                    {
                        throw new ForeignKeyReferenceAlreadyHasValueException();
                    }
        ...
        /// <summary>
        /// There are no comments for FixLookUp in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="FixLookUp_Product", Storage="_FixLookUp", ThisKey="FoodType", OtherKey="FixId", IsForeignKey=true)]
        public FixLookUp FixLookUp
        {
            get
            {
                return this._FixLookUp.Entity;
            }
            set
            {
                FixLookUp previousValue = this._FixLookUp.Entity;
                if ((previousValue != value) || (this._FixLookUp.HasLoadedOrAssignedValue == false))
                {
                    this.SendPropertyChanging("FixLookUp");
                    if (previousValue != null)
                    {
                        this._FixLookUp.Entity = null;
                        previousValue.Products.Remove(this);
                    }
                    this._FixLookUp.Entity = value;
                    if (value != null)
                    {
                        this._FoodType = value.FixId;
                        value.Products.Add(this);
                    }
                    else
                    {
                        this._FoodType = default(int?);
                    }
                    this.SendPropertyChanged("FixLookUp");
                }
            }
        }
